...
async function main() {
  const defaultUserId = '430d8d66-cbef-4632-85f0-ccc3411845ca';

  await prisma.transaction.updateMany({
    where: {
      userId: '5d602981-7e39-4125-b5d4-640e6633fdce'
    },
    data: {
  ...
  console.log('Semua userId berhasil diisi dengan user default');
}
